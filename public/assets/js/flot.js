(() => {
    ...
    $(function () {
        for (var e = [], t = [], a = 0; a < 14; a += 0.1)
            e.push([a, Math.sin(a)]), t.push([a, Math.cos(a)]);
        plot = $.plot("#placeholder1", [{ data: e }, { data: t }], {
            ...
            colors: ["#28a3ddc", "#05c3fb"],
            yaxis: { min: -1.2, max: 1.2, tickLength: 0 },
            xaxis: { tickLength: 0 },
        });
    }),
        $(function () {
            for (var e = [], t = [], a = 0; a < 14; a += 0.5)
                e.push([a, Math.sin(a)]), t.push([a, Math.cos(a)]);
            $.plot(
                "#placeholder2",
                [
        ...
        $(function () {
            ...
            $("#updateInterval")
                ...
                .change(function () {
                    ...
                    e &&
                        !isNaN(+e) &&
                        ((a = +e) < 1 ? (a = 1) : a > 2e3 && (a = 2e3),
                        $(this).val("" + a));
                });
            var i = $.plot("#placeholder4", [t()], {
                series: { shadowSize: 0 },
                grid: { borderColor: "rgba(119, 119, 142, 0.1)" },
                colors: ["#28a3ddc"],
                yaxis: { min: 0, max: 100, tickLength: 0 },
        ...
        $(function () {
            for (var e = [], t = 0; t <= 10; t += 1)
                e.push([t, parseInt(30 * Math.random())]);
            var a = [];
            for (t = 0; t <= 10; t += 1)
                a.push([t, parseInt(30 * Math.random())]);
            var i = [];
            for (t = 0; t <= 10; t += 1)
                i.push([t, parseInt(30 * Math.random())]);
            var o = 0,
                l = !0,
                s = !1,
                n = !1;
            function r() {
                $.plot("#placeholder6", [e, a, i], {
                    series: {
                        stack: o,
                        lines: { show: s, fill: !0, steps: n },
                        bars: { show: l, barWidth: 0.6 },
                    },
                    grid: { borderColor: "rgba(119, 119, 142, 0.1)" },
                    colors: ["#28a3ddc", "#05c3fb"],
                    yaxis: { tickLength: 0 },
            ...
            r(),
                $(".stackControls button").click(function (e) {
                    e.preventDefault(),
                        (o = "With stacking" == $(this).text() || null),
                        r();
                }),
                $(".graphControls button").click(function (e) {
                    e.preventDefault(),
                        (l = -1 != $(this).text().indexOf("Bars")),
                        (s = -1 != $(this).text().indexOf("Lines")),
                        (n = -1 != $(this).text().indexOf("steps")),
                        r();
                });
        }),
        $(function () {
            for (
                var t = [], a = Math.floor(4 * Math.random()) + 3, i = 0;
                i < a;
                i++
            )
                t[i] = {
