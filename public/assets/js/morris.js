$(function (e) {
    ...
    new Morris.Area({
        ...
        new Morris.Bar({
            ...
            ykeys: ["y"],
            labels: ["Y"],
            barColors: function (e, r, o) {
                return "bar" === o
                    ? (Math.ceil((0 * e.y) / this.ymax), "#28a3ddc")
                    : "#000";
            },
        });
    var r = [
    ...
    new Morris.Bar({
        ...
        barColors: ["#28a3ddc", "#05c3fb"],
        xLabelAngle: 0,
        resize: !0,
    });
    var o = 0;
    function a(e) {
        for (var r = [], o = 0; o <= 360; o += 10) {
            var a = (e + o) % 360;
            r.push({
                x: o,
                y: Math.sin((Math.PI * a) / 180).toFixed(4),
                z: Math.cos((Math.PI * a) / 180).toFixed(4),
            });
        }
        return r;
    }
    ...
    setInterval(function () {
        o++, l.setData(a(5 * o)), $("#reloadStatus").text(o + " reloads");
    }, 100),
        (r = [
